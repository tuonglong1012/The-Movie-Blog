...
class CustomImagePipeline(ImagesPipeline):
                ...
                if image_type == "characters":
                    ...
                    for charater_name, charater_link in image_url.items():
                        ...
                        if charater_name and charater_link["voice_actor"]:
                            yield Request(
                                charater_link["voice_actor"],
                                meta={
                                    "anime_id": item["id"],
                                    "image_type": image_type,
                                    "character_name": charater_name,
                                    "character_type": "voice_actor",
                                },
                            )
                else:
                    ...
                    yield Request(
                        image_url,
                        meta={"anime_id": item["id"], "image_type": image_type},
                    )
    ...
    def file_path(self, request, response=None, info=None, *, item=None):
        ...
        if image_type == "characters":
            ...
            sanitized_name = (
                re.sub(r"[^\w\-_]", "_", self.character_name)
            ...
            if character_type == "character":
                ...
                return (
                    f"{image_type}_{anime_id}_{sanitized_name}_unknown{image_extension}"
                )
