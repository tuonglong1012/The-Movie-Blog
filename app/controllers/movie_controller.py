...
def import_movies(db: Session=Depends(get_db)):
    ...
    try:
        ...
        for movie in movies_data:
            member = movie.get("test", {}).get("Members:", "").replace("Members:", "").strip()
            ...
            newMovie = Movie(
                ...
                type = movie.get("test", {}).get("Type:", "").replace("Type:", "").strip(),
                aired = movie.get("test", {}).get("Aired:", "").replace("Aired:", "").strip(),
                members = movie.get("test", {}).get("Members:", "").replace("Members:", "").strip()
            )
            db.add(newMovie)
